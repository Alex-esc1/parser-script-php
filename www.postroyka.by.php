...
$textfile->add_string_to_file($file,$t)."<br>";
$debug->optimize_memory()."<br>";
$t="<p>".$h1->get_inner_text_by_number(0)." \описание\ ".$div->get_by_attribute("class","description_blk", false)->get_inner_text()."</p>";
$textfile->add_string_to_file($file,$t)."<br>";
$debug->optimize_memory()."<br>";
$spn ="<p>".$h1->get_inner_text_by_number(0)." \цена\ ".$div->get_by_attribute("class","base-price", false)->get_inner_text();
